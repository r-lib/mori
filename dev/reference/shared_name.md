...
passed to
[`map_shared()`](https://mori.r-lib.org/dev/reference/map_shared.md) to
open the same region in another process.
...
- x:
  ...
  [`share()`](https://mori.r-lib.org/dev/reference/share.md) or
