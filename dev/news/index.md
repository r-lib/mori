...
- [`share()`](https://r-lib.github.io/mori/dev/reference/share.md) now
  supports S4 objects built on vectors or lists (previously the S4
  object bit was silently dropped).
- [`share()`](https://r-lib.github.io/mori/dev/reference/share.md) of
...
- When [`share()`](https://r-lib.github.io/mori/dev/reference/share.md)
...
- [`share()`](https://r-lib.github.io/mori/dev/reference/share.md) on
